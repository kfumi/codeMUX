...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::git::capture_workspace_baseline,
            commands::artifact::build_turn_artifact,
            commands::artifact::revert_turn_artifact,
            commands::artifact::load_turn_artifacts,
